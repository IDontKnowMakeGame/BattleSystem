...
namespace Acts.Characters.Enemy
{
    public class EnemyAttack : Act
    {
        ...
        public void HorizontalAttack(Vector3 dir, bool isLast = true)
        {
            ...
            var quaternion = degree.GetRotation();  
            Debug.Log(degree);
            ...
            var attackPos = CharacterActor.Position + ( quaternion * Vector3.forward);
        ...
        public void HorizontalAttackWithDelay(Vector3 dir, float delay, bool isLast = true)
        {
            ...
            var quaternion = degree.GetRotation();
            var attackPos = CharacterActor.Position + (quaternion * Vector3.forward);
            InGame.Attack(attackPos, degree, new Vector3(3, 0, 1), DefaultStat.Atk, delay, CharacterActor);
            InGame.Attack(CharacterActor.Position, 0, new Vector3(1, 0, 1), DefaultStat.Atk, delay, CharacterActor, isLast);
        }
